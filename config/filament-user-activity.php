...
return [
    ...
    'access_control' => [
        'enabled' => env('FILAMENT_USER_ACTIVITY_ACCESS_CONTROL_ENABLED', true), // set to true to restrict access to the Resource
        'spatie' => [
        ...
        'allowed' => [
            'emails' => array_map('trim', explode(',', env('FILAMENT_USER_ACTIVITY_ALLOWED_EMAILS', '')) ?? ['admin@admin.com']), // string of comma-delimited emails e.g. 'user1@test.com,user2@test.com'
