...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('movimientos', function (Blueprint $table) {
            ...
            $table->foreignId('bodega_origen_id')->constrained('wharehouses')->cascadeOnDelete()->nullable();
            $table->foreignId('bodega_destino_id')->constrained('wharehouses')->cascadeOnDelete()->nullable();
